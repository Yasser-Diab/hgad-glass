...
insert into public.app_settings (key, value) values
  ...
  ('branding', '{"theme":"gold-black-silver","reportLogo":"icons/app-logo.svg"}'::jsonb)
on conflict (key) do nothing;

insert into public.users (username, display_name, role, password) values
  ('admin', 'Yasser Diab', 'admin', '23320001')
